...
# In Python, you can use comparison operators to compare values.
# When a comparison is made, Python returns a Boolean result: True or False. Note that Boolean data types are not string data types
# (Boolean True is not equal to the string "True").
#
